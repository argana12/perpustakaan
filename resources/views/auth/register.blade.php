<x-guest-layout>
    ...
    @if(isset($google_email))
        <form method="POST" action="{{ url('auth/google/register') }}" id="register-google-form">
            @csrf
            ...
            <div>
                ...
                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="Ketik nama lengkap sesuai identitas" />
    ...
    @else
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" placeholder="Minimal 6 karakter" />
